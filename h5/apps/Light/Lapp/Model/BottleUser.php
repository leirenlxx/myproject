...
class BottleUser extends Model
{
    ...
    public function recordUserInfo($info)
    {
        ...
        //     return $this->add();
        // }
        return $this->execute("insert into jovo_bottle_user(uid,openid,nickname,headimgurl,modified,status) values('" . $info['uid'] . "','" . $info['openid'] . "','" . $info['nickname'] . "','" . $info['avator'] . "','" . NOW_TIME . "',1)");
    }
