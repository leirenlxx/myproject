 ...
 * @version $Id: Lxx.php 2016-05-30T10:22:40+0800
 */
namespace Lxx\Controller;

use Think\Controller;

class Lxx extends Controller
{
    //状态变量
    private $_status;
    ...
    public function index()
    {
        ...
        if (!session('openid')) {
            ...
            $this->assign('jssdk', $jssdk);
            //模板赋值
            $this->assign('uid', session('userinfo.uid'));
            $this->assign('nickname', session('userinfo.nickname'));
    ...
    public function share()
    {
        ...
        $result  = D('LxxBottle')->getBottleUrl($shareid);
        if ($result) {
            $re['status'] = 'success';
            $re['msg']    = '获取成功';
            $re['url']    = $result['img'];
